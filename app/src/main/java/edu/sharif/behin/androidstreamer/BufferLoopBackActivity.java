...
import edu.sharif.behin.androidstreamer.local.BufferLoopBackStream;


public class BufferLoopBackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buffer_loop_back);
        setTitle("Buffer Loop Back Demo");
        ...
        final BufferLoopBackStream loopBackStream= new BufferLoopBackStream();
